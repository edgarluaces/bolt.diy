...
export const meta: MetaFunction = () => {
  return [{ title: 'Mi Perfil - Bolt' }, { name: 'description', content: 'Gestiona tu perfil de usuario' }];
};
    ...
    <div className="flex flex-col h-full w-full bg-bolt-elements-background-depth-1">
      ...
      <main className="flex-1 overflow-y-auto px-6 py-8">
        <div className="max-w-2xl mx-auto">
          {/* Título */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-bolt-elements-textPrimary mb-2">Ajustes</h1>
      ...
      <footer className="border-t border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 px-6 py-4">
        <div className="max-w-2xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-bolt-elements-textSecondary">
